...
output_file1=open(RV_ROOT + '/benchmark/sim_hex/'+programordata+'_dccm' + '_1.hex','w')
output_file2=open(RV_ROOT + '/benchmark/sim_hex/'+programordata+'_dccm' + '_2.hex','w')
output_file3=open(RV_ROOT + '/benchmark/sim_hex/'+programordata+'_dccm' + '_3.hex','w')
output_file4=open(RV_ROOT + '/benchmark/sim_hex/'+programordata+'_dccm' + '_4.hex','w')
...
while True:
    ...
    if line_list[0][0]=='@':
        addr_local=int(line_list[0][6:],16)
